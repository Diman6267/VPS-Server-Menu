...
### 📢 Сообщество и идеи
* **[Комьюнити ITDog]** — за предоставленные скрипты проверки (российские iPerf3 серверы), ценные обсуждения, тесты и неоценимый вклад в развитие свободного интернета в РФ. Вы лучшие! 🐕
...
* **[Censorcheck & IP Region](https://github.com/vernette)** от *vernette* — скрипты для проверки геоблоков и определения принадлежности IP.

...
Удобный набор скриптов для управления сервером Ubuntu. Позволяет в один клик настраивать BBR, фаервол, управлять IPv6, установка и управление MTProxy, а также устанавливать и настраивать X-UI и Hysteria2.
...
- **Прокси**: Быстрая установка и управление 3x-ui, MTProxy и Hysteria 2.
